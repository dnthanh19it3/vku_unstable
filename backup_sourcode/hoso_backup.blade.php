...
{{--                    <img id="avatar_round" class="avatar_round" src="{{$sinhvien->avatar}}" alt="Avatar" title="Change the avatar"/>--}}
                ...
                <div class="profile-usermenu">
                    <ul class="nav" role="tablist">
                        <li class="active">
                            <a id="nav-canhan-tab" data-toggle="tab" href="#nav-canhan" role="tab" aria-controls="nav-canhan" aria-selected="true">
                                <i class="glyphicon glyphicon-home"></i>
                                Cá nhân </a>
                        </li>
                        <li>
                            <a id="nav-khenthuong-tab" data-toggle="tab" href="#nav-khenthuong" role="tab" aria-controls="nav-khenthuong" aria-selected="false">
                                <i class="glyphicon glyphicon-user"></i>
                                Khen thưởng </a>
                        </li>
                        <li>
                            <a id="nav-kyluat-tab" data-toggle="tab" href="#nav-kyluat" role="tab" aria-controls="nav-kyluat" aria-selected="false">
                                <i class="glyphicon glyphicon-ok"></i>
                                Kỷ luật </a>
                        </li>
                        <li>
                            <a id="nav-renluyen-tab" data-toggle="tab" href="#nav-renluyen" role="tab" aria-controls="nav-renluyen" aria-selected="false">
                                <i class="glyphicon glyphicon-flag"></i>
                               Rèn luyện </a>
                        </li>
                        <li>
                            <a id="nav-timeline-tab" data-toggle="tab" href="#nav-timeline" role="tab" aria-controls="nav-about" aria-selected="false">
                                <i class="glyphicon glyphicon-flag"></i>
                               Timeline </a>
                        </li>
                    </ul>
