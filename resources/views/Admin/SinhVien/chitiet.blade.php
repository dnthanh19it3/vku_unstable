        ...
        <div class="profile-sidebar">
            ...
            <div class="profile-usertitle">
                ...
                <div class="profile-usertitle-job">
                    <i class="fa fa-id-card-alt mr-2"></i> MSV {{$sinhvien->masv}} <i class="fa fa-briefcase mr-2"></i> LỚP {{$sinhvien->tenlop}}<i class="fa fa-briefcase mr-2"></i> KHOÁ {{$sinhvien->khoahoc}}
                </div>
                <div class="profile-usertitle-job">
                    <i class="fa fa-briefcase mr-2"></i>NGÀNH {{$sinhvien->tenNganh}}
                </div>
                <div class="profile-usertitle-job">
                    <i class="fa fa-briefcase mr-2"></i>{{$sinhvien->tenKhoa}}
                </div>
            </div>
