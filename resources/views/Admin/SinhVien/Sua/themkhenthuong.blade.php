            ...
            <div class="tab-content" style="height: 100%">
                <div class="tab-pane active" id="canhan">
                    <div class="profile_main_block p-4 bg-white">
                        <h4 style="display: flex; flex-direction: row; align-items: center"><img src="{{$sinhvien_static->anhthe}}" class="avatar mr-2" style="border-radius: 99px"/> Thêm khen thưởng - {{$sinhvien_static->hodem . " " . $sinhvien_static->ten . " (" . $sinhvien_static->masv . ")"}}</h4>
                        <hr/>
                        <form id="khenthuong-form" action="{{route('ad.suasinhvien.khenthuong.them', ['masv' => $sinhvien->masv])}}" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-12 col-lg-6">
                                    ...
                                    <div class="col-9">
                                        <input id="thoigian" name="thoigian" type="date" class="form-control rounded" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
