            ...
            <form id="fillter" class="bg-white p-3 mb-3" method="get" action="{{route('ad.hoplop.listhoplop.nullable')}}">
                ...
                <select id="namhoc" class="form-control rounded">
                    @foreach($list_kyhoc as $key => $value)
                        <option value="{{$value->id}}">Năm học {{$value->nambatdau . "-" .$value->namketthuc}}</option>
                    @endforeach
                </select>
                <hr/>
            ...
            <div class="bg-white p-3 mb-3">
                ...
                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    @foreach($months as $value)
                        <a class="nav-link" id="account-tab"
                           href="{{route('ad.hoplop.listhoplop', ['namhoc' => $namhoc, 'hocky' => $hocky, 'thang' => $value])}}">
...
{{--                </div>--}}
        ...
        <div class="col-md-9">
            <div class="bg-white p-3">
                <h6><i class="fas fa-list mr-2"></i>Danh sách biên bản</h6>
                <hr/>
                <div class="row">
